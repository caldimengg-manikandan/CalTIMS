        ...
        <div className="w-full">
            ...
            >
                    ...
                    {step === 1 && (
                        <motion.div key="step1" variants={slideVariants} initial="enter" animate="center" exit="exit" className="space-y-6">
                            ...
                            <form onSubmit={emailForm.handleSubmit(sendOTP)} className="space-y-5">
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            type="email"
                                            className="w-full h-12 pl-12 pr-4 bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-xl text-sm font-bold text-slate-900 dark:text-white outline-none focus:ring-2 focus:ring-indigo-600/10 focus:border-indigo-600 transition-all"
                                ...
                                <button type="submit" disabled={isSending} className="w-full h-12 bg-slate-900 dark:bg-white text-white dark:text-black rounded-xl font-black text-xs uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-xl shadow-slate-200 dark:shadow-none">
                                    {isSending ? <Spinner size="sm" /> : <span>Send Code</span>}
                                </button>
                            </form>
                        </motion.div>
                    )}
                            ...
                            <form onSubmit={otpForm.handleSubmit(verifyOTP)} className="space-y-5">
                                <div className="space-y-1.5 text-center">
                                    ...
                                    <input
                                        ...
                                        maxLength={6}
                                        autoFocus
                                        className="w-full h-14 text-center text-2xl font-black tracking-[0.5em] bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white outline-none focus:ring-2 focus:ring-indigo-600/10 focus:border-indigo-600 transition-all"
                                        placeholder="000000"
                                    />
                                ...
                                <button type="submit" disabled={isVerifying} className="w-full h-12 bg-indigo-600 text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-indigo-700 transition-all flex items-center justify-center gap-2 shadow-lg shadow-indigo-200 dark:shadow-none">
                                    {isVerifying ? <Spinner size="sm" color="white" /> : <span>Verify & Continue</span>}
                                </button>

                                <button type="button" onClick={() => setStep(1)} className="w-full text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-slate-900 transition-colors">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                className="w-full h-12 pl-12 pr-12 bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-xl text-sm font-bold text-slate-900 dark:text-white outline-none focus:ring-2 focus:ring-indigo-600/10 focus:border-indigo-600 transition-all"
                                                placeholder="••••••••"
                                            />
                ...
                <div className="mt-8 pt-6 border-t border-slate-50 dark:border-slate-800/50">
                    <Link to="/login" className="flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-indigo-600 transition-all group">
