                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-black border border-slate-100 dark:border-white">
                            ...
                            <button onClick={() => upd('strictDailyHours', !form.strictDailyHours)}
                                className={`relative w-11 h-6 rounded-full transition-colors ${form.strictDailyHours ? 'btn-primary' : 'bg-slate-300 dark:bg-white/20'}`}>
                        ...
                        <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-black border border-slate-100 dark:border-white">
                            ...
                            <button onClick={() => upd('isWeekendWorkable', !form.isWeekendWorkable)}
                                className={`relative w-11 h-6 rounded-full transition-colors ${form.isWeekendWorkable ? 'btn-primary' : 'bg-slate-300 dark:bg-white/20'}`}>
...
function AttendanceTab() {
    return (
        <div className="space-y-6">
                ...
                >
                    <div className="space-y-6">
                        <div className="flex items-center justify-between p-5 rounded-2xl bg-slate-50 dark:bg-black border border-slate-100 dark:border-white transition-all hover:border-amber-200">
                            ...
                            <button className="px-5 py-2.5 btn-primary hover:bg-primary-700 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-primary/20 active:scale-95">
            ...
            <div className="p-4 rounded-xl bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-700/30 text-xs text-primary-700 dark:text-indigo-300 leading-relaxed">
