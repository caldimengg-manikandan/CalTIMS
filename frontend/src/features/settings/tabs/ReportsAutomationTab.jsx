                ...
                <div className="mt-4 space-y-3">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-xl border text-sm font-bold transition-all ${sendPdfPanel
                            ? 'bg-primary dark:bg-indigo-900/30 border-indigo-300 dark:border-primary text-primary dark:text-indigo-300'
                    ...
                    {sendPdfPanel && (
                        <div className="rounded-xl border border-indigo-100 dark:border-indigo-900/50 bg-primary/60 dark:bg-indigo-900/20 p-4 space-y-3">
                            <p className="text-xs font-semibold text-primary dark:text-indigo-300 flex items-center gap-1.5">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-5 py-2 rounded-xl btn-primary hover:btn-primary hover:bg-primary-700 text-white text-sm font-bold shadow-md shadow-primary/20 disabled:opacity-50 transition-all">
        ...
        <div className="space-y-8 pb-10">
            ...
            <div className="flex flex-wrap items-center justify-between gap-6">
                ...
                <button onClick={openCreate}
                    className="flex items-center gap-2.5 px-6 py-3 rounded-2xl btn-primary text-white text-xs font-black uppercase tracking-widest shadow-xl shadow-primary/20 hover:btn-primary hover:bg-primary-700 transition-all active:scale-95">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    {[
                                        ...
                                        >
                                            ...
                                            <span className={`text-xs font-black ${globalSettings.defaultFormat === fmt.id ? 'text-primary dark:text-primary' : 'text-slate-500'}`}>{fmt.id}</span>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="p-4 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/10 flex items-start gap-3">
                                    <div className="w-1.5 h-1.5 rounded-full bg-primary0 mt-1.5 flex-shrink-0" />
                ...
                <div className="lg:col-span-4 p-6 rounded-[2rem] bg-slate-900 border border-white/5 shadow-2xl flex flex-col justify-between min-h-[200px]">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="p-2.5 rounded-xl bg-primary0/20 text-primary">
                            <Mail size={20} />
                        </div>
                    ...
                    <div>
                        ...
                        <p className="text-xs font-black text-primary uppercase tracking-widest mb-4">Active Pipelines</p>
            ...
            <SectionCard title="Automation Pipelines" subtitle="Granular delivery schedules and specialized report triggers" icon={Clock}>
                {isLoading ? (
                    ...
                    <div className="py-24 text-center">
                        ...
                        <button onClick={openCreate} className="mt-6 px-6 py-3 rounded-2xl btn-primary text-white text-[10px] font-black uppercase tracking-widest shadow-xl shadow-primary/20 hover:btn-primary hover:bg-primary-700 transition-all">
                            Initialize Pipeline
                        </button>
                    </div>
                ) : (
                                    ...
                                    <div className="p-5 flex flex-wrap items-center gap-5">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex flex-wrap items-center gap-4 text-[10px] font-bold text-slate-400">
                                                <span className="flex items-center gap-1.5 capitalize"><Clock size={11} className="text-primary" /> {s.frequency} @ {s.scheduledTime}</span>
                                                <span className="flex items-center gap-1.5"><Mail size={11} className="text-primary" /> {s.recipientIds?.length || 0} Recipients</span>
